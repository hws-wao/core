...
var CookieService = (function() {
   ...
   */
  CookieService.prototype.get = function(key, value) {
    var d = $.Deferred();
   ...
   * @param {object} value Cookieの値
   */
  CookieService.prototype.post = function(key, value) {
    var d = $.Deferred();
    var ret = {};
   ...
   * @param {object} value Cookieの値
   */
  CookieService.prototype.patch = function(key, value) {
   ...
   */
  CookieService.prototype.delete = function(key, value) {
    value = null;
    var d = $.Deferred();
    // valueは文字列（Cookie名）の配列である想定で
    // パラメタチェックせずに次処理へ回す
