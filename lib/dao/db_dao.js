...
var Db = (function() {
  ...
  // @return {promise}
  Db.prototype.close = function(args) {
    var that = this;
  ...
  // @return {promise}
  Db.prototype.insert = function(args) {
    var that = this;
  ...
  // @return {promise}
  Db.prototype.remove = function(args) {
    var that = this;
  ...
  // @return {promise}
  Db.prototype.update = function(args) {
    var that = this;
  ...
  // @return {promise}
  Db.prototype.count = function(args) {
    var that = this;
  ...
  // @return {promise}
  Db.prototype.find = function(args) {
    var that = this;
