...
module.exports = {
  ...
  start: function() {
    ...
    jsdom.jQueryify(window, JQUERY_URL, function(window, $$) {
      ...
      var serverName = global.serverName || serverConfig.name;
      var serverPort = global.serverPort || serverConfig.port
      var app = new App({ wao: that, name: serverName, port: serverPort });
      app.start();
      that.apps.push(app);
    });
  },
